...
//			ranges.put(BigDecimal.valueOf(267),">= 267 ");
			...
			IntStream stream3 = IntStream.range(267, 365);
				...
				long actual=Gold.test(noOfDaysBetween,stream);
				long actual1=Gold.test1(noOfDaysBetween,stream1);
				long actual2=Gold.test2(noOfDaysBetween,stream2);
				long actual3=Gold.test3(noOfDaysBetween,stream3);
